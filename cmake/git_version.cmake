...
function(version_extract)
	...
	if(Git_FOUND)
		...
		if("${GIT_VERSION_TAG}" STREQUAL "")
			...
			set(version_git_tag "${GIT_VERSION_TAG}")
		endif()
	...
	if("${GIT_VERSION}" MATCHES "^[0-9]+\\.[0-9]+\\.[0-9]+([-+].*)?$")
		...
		if(NOT "${PROJECT_VERSION}" STREQUAL "")
			# Fallback to project version information.
			set(GIT_VERSION_TRIPLET "${PROJECT_VERSION}")
			set(GIT_VERSION_MAJOR "${PROJECT_VERSION_MAJOR}")
			set(GIT_VERSION_MINOR "${PROJECT_VERSION_MINOR}")
			set(GIT_VERSION_PATCH "${PROJECT_VERSION_PATCH}")
		else()
			# Choose a high major number, such that it is always incompatible with
			# existing tags.
